...
- `00:10-00:20`
  - There are 4 PDFs in `pdf_folder/`.
  - Requirement: fixed four-text corpus in one session.
...
- `04:22-04:86`
  - Text order and alternation pattern for texts 3-4 was listed.
  - Final product-owner lock: strict alternation through all 4 texts.
...
- Strict alternation is locked for all four texts; text 4 is `PDF -> words`.
